...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col md:flex-row w-full overflow-x-hidden relative">
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex justify-center items-center p-4">
          <div className="bg-white rounded-lg shadow-xl w-full max-w-md p-6 relative">
            ...
            <h3 className="text-lg font-bold text-gray-800 mb-4 flex items-center gap-2">
              <HardHat className="text-orange-600" /> Sync to Procore
            </h3>
            ...
            {syncStatus === 'idle' && (
              <div className="space-y-4">
                ...
                <button onClick={handleStartSync} className="w-full bg-orange-600 hover:bg-orange-700 text-white py-2.5 rounded-md font-medium transition-colors">
                  Start Sync
                </button>
              </div>
            )}
                ...
                <div className="flex flex-col items-center justify-center text-center space-y-2">
                  ...
                  {syncStatus === 'error' && (
                    <>
                      ...
                      <button onClick={handleStartSync} className="flex items-center gap-2 bg-red-100 text-red-700 px-4 py-2 rounded-md hover:bg-red-200 transition font-medium text-sm">
      ...
      {/* Sidebar Navigation - FULLY RESTORED */}
      ...
      <div className="flex-1 flex flex-col w-full bg-slate-50 overflow-y-auto">
        ...
        <main className="flex-1 p-3 md:p-6 flex flex-col w-full">
          ...
          {/* Quick Add Configurator Panel - FULLY RESTORED */}
